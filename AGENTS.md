...
* 每次完成工作之后，按照 STATUS.md 的规范更新状态。
* 每次解决对应的问题之后，为我总结对应问题解决的方法论以及可以增加到 AGENTS.md 中的约束。
